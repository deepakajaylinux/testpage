...
this command will list all the names of the modules that are available under ptconfigure.
...
The screenshot shown under explains the usage of the module Behat under ptconfigure using the help command.
